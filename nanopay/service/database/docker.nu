...
export def 'nu-complete services' [] {
  open $env.DATABASE_COMPOSE | get services | transpose key value | get key
}

def --wrapped compose [...args] {
  docker compose --env-file $env.DATABASE_ENV --file $env.DATABASE_COMPOSE ...$args
}
